  ...
  return (
    <div className='stream box overflow-hidden'>
      ...
      <div className='stream-info p-6'>
         <div className='stream-date text-xs text-gray-200'><TimeFormat date={data.createdAt} /></div>
         {data.endedAt ? <div className='stream-date text-xs text-main mt-2'><TimeFormat date={data.endedAt} /></div> : ''}
