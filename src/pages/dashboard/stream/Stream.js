  ...
  return (
    <div className='stream box overflow-hidden'>
      <div className='stream-img w-full relative' >
         ...
         font-bold bg-green-700 text-white rounded-xl px-3 py-1 ${data.status == '1' ? "bg-red-800 " : "bg-yellow-700"}`} >
      ...
      <div className='stream-info p-6'>
         ...
         <a target='_blank' rel="noreferrer" href={`https://www.youtube.com/watch?v=${data.streamId}`} className={`${data.status === '0' ? "disabled" : ""} btn btn-main sm flex items-center justify-center`}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
