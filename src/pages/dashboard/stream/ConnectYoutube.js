...
export default function ConnectYoutube({channel}) {
  ...
  return (
    <div>
      <div disabled={loading} onClick={LinkYoutube} class={`${loading ? "disabled" : ""} inline-flex mb-4 items-center justify-center px-4 ms:px-6 w-full cursor-pointer py-1 sm:py-3 text-base font-medium rounded-[20px] sm:rounded-[30px] bg-gray-50 hover:text-gray-900 hover:bg-gray-100  `}>
