            ...
            <div class="flex justify-center w-full mx-auto">
               <div class=" w-full bg-white sm:rounded-lg">
                  <div class="mb-4 md:mb-10 text-center">
                     ...
                     <p class="text-md text-gray-500">File should be of format .mp4, .png, .jpeg or .avif</p>
                  </div>
                  ...
                  <div class="relative w-full max-w-xs mb-10  bg-white bg-gray-200 rounded-lg border border-dashed m-auto">
                        <input onChange={handleFile} type="file" id="file-upload" class="hidden" />
                        <label for="file-upload" class="z-20 flex flex-col-reverse items-center justify-center w-full cursor-pointer p-8">
