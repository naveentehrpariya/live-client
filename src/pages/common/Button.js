...
export default function Button({to, text, classes}) {
  return (
    <Link to={to} className={`${classes} ps-5 inline-flex  rounded-[40px] p-2 btn text-[20px] w-auto items-center justify-between`} >
      {text} <div className='ms-3 flex items-center justify-center arrow bg-white w-[40px] h-[40px]  rounded-[50%]' ><svg width="23" height="8" viewBox="0 0 23 8" fill="none" xmlns="http://www.w3.org/2000/svg">
