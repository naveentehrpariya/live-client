  ...
  return (
   ...
   `}</style>
    <section className="py-20">
      <div className=" overflow-hidden relative takesection max-w-[996px] m-auto flex flex-col items-center py-28 px-20 text-lg leading-4 text-center text-white rounded-3xl  bg-slate-950 max-w-[996px]">
            <div className="max-w-[700px] relative z-[3]">
               <h2 className='heading-lg text-center px-5 ' >Let's take your <span className="text-main" > streaming </span>
