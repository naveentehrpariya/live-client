        ...
        <div className='features-cols mt-10 xl:mt-16 xl:grid grid-cols-2 gap-4' >
          ...
          <div className='features-faq'>
            <div className="mb-6 transition-all duration-200 bg-dark1 rounded-[20px] cursor-pointer">
                <button type="button" className="flex items-center justify-between w-full p-7">
                    <span className="flex text-[21px] font-semibold text-white font-mona"> Start Your 24/7 Live Stream in Minutes </span>
                ...
                <div className="text-gray-500 p-6 pt-0">
            ...
            <div className="mb-6 transition-all duration-200 bg-dark1 rounded-[20px] cursor-pointer">
                <button type="button" className="flex items-center justify-between w-full p-7">
                    <span className="flex text-[21px] font-semibold text-white font-mona"> Simple Drag & Drop 24/7 Stream Builder </span>
                    <svg className="w-6 h-6 text-gray-400 rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <div className="text-gray-500 d-none p-6 pt-0">
            ...
            <div className="mb-6 transition-all duration-200 bg-dark1 rounded-[20px] cursor-pointer">
                <button type="button" className="flex items-center justify-between w-full p-7">
                    <span className="flex text-[21px] font-semibold text-white font-mona">Schedule & Broadcast Pre-Recorded Videos </span>
                    <svg className="w-6 h-6 text-gray-400 rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
            ...
            <div className="mb-6 transition-all duration-200 bg-dark1 rounded-[20px] cursor-pointer">
                <button type="button" className="flex items-center justify-between w-full p-7">
                    <span className="flex text-[21px] font-semibold text-white font-mona"> Multi-Channel Audio Support </span>
                    <svg className="w-6 h-6 text-gray-400 rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
