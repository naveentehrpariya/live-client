...
export default function Hero() {
  return <div className='hero-section'>
      <div className='container m-auto ' >
         <div className='max-w-[800px] py-24 m-auto' >
            <h2 className='heading-xl text-center px-8 m-auto' >24/7 YouTube <span className='text-main' >Live Stream</span> Pre-Recorded Videos</h2>
