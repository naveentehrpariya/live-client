   ...
   <HomeLayout>
      <div className='py-6 md:py-12'>
         <div class="container mx-auto  text-white">
            <h1 class="text-2xl md:text-3xl font-bold mb-8">Cancellation and Refund Policy</h1>
            <div class="mb-8">
               ...
               <p>To cancel your package, please send a cancellation request to our customer service email address: <a href="mailto:support@runstream.co" class="text-blue-500 hover:underline">support@runstream.co</a></p>
            </div>
            <div class="mb-8">
               <h2 class="text-xl md:text-2xl font-bold mb-4">Refund Procedure</h2>
            ...
            <div class="mb-8">
               <h2 class="text-xl md:text-2xl font-bold mb-4">Cancellation Deadline</h2>
            ...
            <div class="mb-8">
               ...
               <p>If you have any questions or concerns regarding our Cancellation and Refund Policy, please don't hesitate to reach out to our customer service team at <a href="mailto:support@runstream.co" class="text-blue-500 hover:underline">support@runstream.co</a>.</p>
            </div>
            </div>
