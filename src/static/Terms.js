...
export default function Terms() {
  return (
   <HomeLayout title="Terms and conditions">
      <div className='container'>
         ...
         <h2 className="text-lg md:text-xl font-bold mb-2 mt-4 pt-3">6. Subscriptions</h2>
         <p className="text-gray-300 mb-4">
         ...
         <h2 className="text-lg md:text-xl font-bold mb-2 mt-4 pt-3">7. Free Trial</h2>
         <p className="text-gray-300 mb-4">
         ...
         <h2 className="text-lg md:text-xl font-bold mb-2 mt-4 pt-3">12. Amendments and Updates</h2>
         <p className="text-gray-300 mb-4">
         ...
         <h2 className="text-lg md:text-xl font-bold mb-2 mt-4 pt-3">13. Contact Us</h2>
         <p className="text-gray-300 mb-4">
