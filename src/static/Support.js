     ...
     <div class="py-6 md:py-12 text-white ">
      ...
      <div class="my-4">
         ...
         <div class="w-full md:w-1/2 mb-4 md:mb-0">
            ...
            <p class="text-gray-300 mt-4">Support Hours: Our dedicated support team is available to assist you during our operating hours:</p>
            <ul class="list-disc pl-5">
      ...
      <div class="my-4">
         <div class="w-full md:w-1/2 mb-4 md:mb-0">
            ...
            <li><a href="https://www.facebook.com/RunStream.co" class="text-blue-500 hover:text-blue-600">Facebook: RunStream.co</a></li>
            <li><a href="https://www.instagram.com/RunStream.Co" class="text-blue-500 hover:text-blue-600">Instagram: @RunStream.Co</a></li>
            </ul>
         </div>
         <div class="w-full mt-4">
            <p class="text-gray-100 text-center md:text-left">Your satisfaction is our priority. Thank you for choosing RunStream.co.</p>
         </div>
      </div>
      </div>
      </div>
