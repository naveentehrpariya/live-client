...
export default function StreamLayout({children, disabled,  onclick}) {
   ...
   <>
      <div className="bg-dark1 stream-auth-wrap">
            ...
            <div className="bg-dark1 absolute w-full top-0 flex justify-between items-center p-6 border-b border-gray-800 " >
               ...
               <button disabled={disabled} onClick={onclick} className="flex items-center text-white bg-main px-5 py-2 rounded-2xl" >
